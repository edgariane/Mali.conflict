...
<div class="overlay" id="popupOverlay">
    <div class="popup">
        <p>Mit dem Klick auf "<a href="nutzungsbedingungen.html" target="_blank">Nutzungsbedingungen</a>" und "<a href="#richtlinien" target="_blank">Richtlinien</a>" akzeptieren Sie diese.</p>
